...
if __name__ == '__main__':
    ...
    viz.plot_confusion_matrix(y, pred_class, np.arange(1,11), filename='confusion_matrix_nn_4.png')
    viz.plot_confusion_matrix(y, pred_class, np.arange(1,11), normalize=True, filename='confusion_matrix_nn_4_norm.png')
